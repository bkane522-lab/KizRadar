...
const CURATED_SEED_KEY = 'kizradar:migration:curated-events-2026-v1';
const LEGACY_DEMO_CLEANUP_KEY = 'kizradar:migration:remove-demo-events-v1';
...
const CURATED_EVENTS = [
  {
    id: 'curated-salsa-co-chatillon-2026-08-28',
    title: 'Soirée dansante SBK — Salsa & Co',
    style: 'SBK',
    city: 'Châtillon-sur-Loire',
    location: 'Centre socio-culturel, Place du Champ de Foire, 45360 Châtillon-sur-Loire',
    address: 'Place du Champ de Foire, 45360 Châtillon-sur-Loire, France',
    lat: 47.5920524,
    lng: 2.7593282,
    startAt: '2026-08-28T18:00:00.000Z',
    endAt: '2026-08-28T21:59:59.000Z',
    dj: '',
    price: '',
    organizer: 'Salsa & Co',
    submitterEmail: '',
    link: 'https://www.tourismeloiret.com/fr/diffusio/agenda/soiree-dansante-chatillon-sur-loire_TFOFMACEN045V50BQO0',
    description: 'Initiation salsa annoncée à 20 h, puis soirée SBK, Salsa, Bachata et Kizomba. Buvette et restauration créole. L’heure de fin n’étant pas publiée, la fiche expire à 23 h 59.',
    status: 'approved',
    source: 'curated',
    ...
    rejectedAt: '',
    archivedAt: '',
    submittedFrom: 'KizRadar',
  },
  {
    id: 'curated-dance-affinity-festival-2026',
    title: 'Dance Affinity Festival 2026',
    style: 'Festival',
    city: 'Freiburg im Breisgau',
    location: 'M.A.K. Studios, Kaiser-Joseph-Straße 268, 79098 Freiburg im Breisgau',
    address: 'Kaiser-Joseph-Straße 268, 79098 Freiburg im Breisgau, Allemagne',
    lat: 47.991997,
    lng: 7.848298,
    startAt: '2026-10-30T19:00:00.000Z',
    endAt: '2026-11-02T03:00:00.000Z',
    dj: '',
    price: '',
    organizer: 'Dance Affinity',
    submitterEmail: '',
    link: 'https://www.instagram.com/dance.affinity/',
    description: 'Festival Kizomba et Urban Kiz à Freiburg. Édition annoncée du 30 octobre au 2 novembre 2026 au M.A.K. Studios.',
    status: 'approved',
    source: 'curated',
    createdAt: '2026-07-14T00:00:00.000Z',
    updatedAt: '2026-07-14T00:00:00.000Z',
  ...
  {
    id: 'curated-paris-kizomba-congress-2026',
    title: 'Paris Kizomba Congress 2026 — PKC',
    style: 'Festival',
    city: 'Tremblay-en-France',
    location: 'Hilton Paris Charles de Gaulle Airport, 8 Rue de Rome, 93290 Tremblay-en-France',
    address: '8 Rue de Rome, 93290 Tremblay-en-France, France',
    lat: 49.010263,
    lng: 2.557379,
    startAt: '2026-11-19T19:00:00.000Z',
    endAt: '2026-11-23T06:00:00.000Z',
    dj: '',
    price: '',
    organizer: 'Cocktail Dance',
    submitterEmail: '',
    link: 'https://my.weezevent.com/paris-kizomba-congress-2026',
    description: 'Paris Kizomba Congress 2026. Préparty annoncée le 19 novembre, puis festival au Hilton Paris Charles de Gaulle du 20 au 23 novembre.',
    status: 'approved',
    source: 'curated',
    createdAt: '2026-07-14T00:00:00.000Z',
    updatedAt: '2026-07-14T00:00:00.000Z',
  ...
  {
    id: 'curated-lovely-kiz-gold-edition-2026',
    title: 'Lovely Kiz Gold Edition — Kizomba & Bachata',
    style: 'Festival',
    city: 'Sorigny',
    location: 'Domaine de Thais, Lieu-dit Thais, 37250 Sorigny',
    address: 'Domaine de Thais, Lieu-dit Thais, 37250 Sorigny, France',
    lat: 47.256644,
    lng: 0.697541,
    startAt: '2026-11-27T19:00:00.000Z',
    endAt: '2026-11-29T20:00:00.000Z',
    dj: '',
    price: 'À partir de 70 € selon la formule',
    organizer: "Sensa'kiz",
    submitterEmail: '',
    link: 'https://my.weezevent.com/lovely-kiz-festival-gold-edition',
    description: 'Festival Kizomba et Bachata du 27 au 29 novembre 2026 au Domaine de Thais, à Sorigny.',
    status: 'approved',
    source: 'curated',
    createdAt: '2026-07-14T00:00:00.000Z',
    updatedAt: '2026-07-14T00:00:00.000Z',
...
const LEGACY_DEMO_TITLES = new Map([
  ['1', 'Soirée Kizomba du Vendredi'],
  ['2', 'Urban Kiz Night'],
  ['3', 'Semba Festif Weekend'],
  ['4', 'SBK Saturday'],
  ['5', 'Tarraxo Sunset'],
]);
...
async function ensureCuratedEvents() {
  const alreadySeeded = await redis(['GET', CURATED_SEED_KEY]);
  if (alreadySeeded) return;

  const commands = [];
  for (const rawEvent of CURATED_EVENTS) {
    const event = normalizeStoredEvent(rawEvent, rawEvent.id);
    ...
    commands.push(['HSETNX', GOING_KEY, String(event.id), '0']);
    commands.push([
      'HSETNX',
      DEDUPE_KEY,
      event.fingerprint,
...
async function removeLegacyDemoEvents() {
  const alreadyCleaned = await redis(['GET', LEGACY_DEMO_CLEANUP_KEY]);
  if (alreadyCleaned) return;

  const ids = [...LEGACY_DEMO_TITLES.keys()];
  const rawValues = await pipeline(
    ids.map((id) => ['HGET', EVENTS_KEY, id])
  );
  ...
  ids.forEach((id, index) => {
    ...
    try {
      ...
      if (event && event.title === LEGACY_DEMO_TITLES.get(id)) {
        commands.push(['HDEL', EVENTS_KEY, id]);
        commands.push(['HDEL', GOING_KEY, id]);
      }
    } catch {
      // Une entrée illisible n'est jamais supprimée automatiquement.
    }
  });
